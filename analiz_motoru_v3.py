...
# ====== DOSYA YOLLARI ======
VERI_KLASORU = r"C:\ProgrammingFile\Python\IstanbulUlasimProjesi\veriler\ham_veri"
...
try:
    ...
    print(f"✓ Metro verileri: {len(ilce_metro)} ilçe")
...
if trafik_var:
    ...
    print("  ✓ Trafik verileri ağırlığa dahil edildi (%30)")
else:
...
print("   python ai_oneri_sistemi_39ilce.py")
print("=" * 70)